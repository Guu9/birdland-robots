...
| Internally referenced GH — 10%; functionality, legibility, efficiency | `grasshopper/Birdland-Python3.gh`; geometry, event panels and script source embedded | Reloaded and solved. Requires installed Robots/UniversalRobot and Rhino 8 Python 3 support, but no external geometry or timing file. Renderer/camera effects are separate presentation scripts. |
